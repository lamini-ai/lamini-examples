...
class LaminiClassifier:
    ...
    def load(filename):
        with open(filename, "rb") as f:
            classifier = LaminiClassifier.loads(f.read())
            new_classifier = LaminiClassifier()
            new_classifier.logistic_regression = classifier.logistic_regression
            new_classifier.class_names_to_ids = classifier.class_names_to_ids
            new_classifier.class_ids_to_metadata = classifier.class_ids_to_metadata
